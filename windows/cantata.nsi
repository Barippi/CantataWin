...
InstallDir "$PROGRAMFILES\Cantata"
# This will be in the installer/uninstaller's title bar
Name "Cantata"
Icon "cantata.ico"
outFile "Cantata-2.3.3-Setup.exe"
...
section "install"
    ...
    # Start Menu
    createShortCut "$SMPROGRAMS\Cantata.lnk" "$INSTDIR\cantata.exe" "" "$INSTDIR\cantata.exe"
 
    # Registry information for add/remove programs
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "DisplayName" "Cantata"
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "UninstallString" "$\"$INSTDIR\uninstall.exe$\""
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "QuietUninstallString" "$\"$INSTDIR\uninstall.exe$\" /S"
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "InstallLocation" "$\"$INSTDIR$\""
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "DisplayIcon" "$\"$INSTDIR\cantata.exe$\""
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "Publisher" "Cantata"
#    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "HelpLink" "$\"$\""
#    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "URLUpdateInfo" "$\"$\""
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "URLInfoAbout" "$\"http://cantata.mpd$\""
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "DisplayVersion" "2.3.3"
    WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "VersionMajor" 2
    WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "VersionMinor" 3
    # There is no option for modifying or repairing the install
    WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "NoModify" 1
    WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "NoRepair" 1
    # Set the INSTALLSIZE constant (!defined at the top of this script) so Add/Remove Programs can accurately report the size
    # WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata" "EstimatedSize" 
sectionEnd
...
section "uninstall"
    ...
    DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Cantata Cantata"
sectionEnd
